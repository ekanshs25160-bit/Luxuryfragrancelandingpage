...
export function CategoryBanners() {
  return (
    <section id="blogs" className="bg-light flex flex-col scroll-mt-24">
      <motion.div 
      ...
      <div className="flex flex-col-reverse md:flex-row w-full min-h-[80vh] relative overflow-hidden group">
        ...
        <div className="md:w-1/2 w-full bg-light text-brand flex flex-col justify-center px-10 md:px-24 py-20 relative z-20">
          <motion.div
          ...
          >
            ...
            <p className="font-sans text-brand/70 text-sm md:text-base leading-[1.8] tracking-wide max-w-md mb-12">
            ...
            <button className="text-accent hover:text-brand font-sans text-[11px] font-bold uppercase tracking-[0.15em] transition-all duration-300 w-max border-b-2 border-accent hover:border-brand pb-1 flex items-center gap-2 group/btn">
        ...
        <div className="md:w-1/2 w-full h-[50vh] md:h-auto relative z-10 bg-light flex items-center justify-center p-0">
          <div 
      ...
      <div className="flex flex-col md:flex-row w-full min-h-[80vh] relative overflow-hidden group mt-12 md:mt-20">
        ...
        <div className="md:w-1/2 w-full h-[50vh] md:h-auto relative z-10 bg-dark">
          <div 
            className="absolute inset-0 bg-cover bg-center transition-transform duration-[1.5s] group-hover:scale-105"
          ...
          <div className="absolute inset-y-0 right-[-10%] w-[20%] bg-gradient-to-r from-transparent to-brand hidden md:block" />
        </div>

        {/* Right Side: Category Title and Description */}
        <div className="md:w-1/2 w-full bg-brand text-light flex flex-col justify-center px-10 md:px-24 py-20 relative z-20">
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true, margin: "-100px" }}
          ...
          >
            ...
            <p className="font-sans text-light/70 text-sm md:text-base leading-[1.8] tracking-wide max-w-md mb-12">

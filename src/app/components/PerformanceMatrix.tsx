...
export function PerformanceMatrix() {
  return (
    <section className="py-32 px-6 md:px-16 bg-[#F3E5F5] text-[#2D004B] border-t border-b border-gray-200">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
        
        <div className="lg:w-1/3 text-center lg:text-left">
          <Beaker className="w-12 h-12 text-[#D4AF37] mb-6 mx-auto lg:mx-0" />
          <h2 className="font-serif text-4xl md:text-5xl mb-6 tracking-[0.05em] font-medium">
            The Layering Lab
          </h2>
          <p className="font-sans text-gray-700 leading-relaxed mb-8 tracking-wide">
          ...
          <button className="uppercase tracking-widest text-[#2D004B] font-sans text-sm font-bold border-b-2 border-[#D4AF37] pb-1 hover:text-[#D4AF37] transition-colors">
            Discover Our Process
          </button>
        </div>

        <div className="lg:w-2/3 w-full bg-white p-8 md:p-12 shadow-xl rounded-sm border border-[#2D004B]/10">
          <h3 className="uppercase text-xs font-sans tracking-[0.2em] font-bold text-gray-500 mb-10 text-center">
            ...
            {DATA.map((item, i) => (
              <div key={item.title} className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
                <div className="md:w-1/3 text-center md:text-right w-full">
                  <h4 className="font-serif text-xl text-[#2D004B] font-medium tracking-wide">
                    {item.title}
                  </h4>
                  <p className="font-sans text-[#D4AF37] text-[10px] uppercase tracking-widest mt-1">
                    {item.concentration}
                  </p>
                </div>
                ...
                <div className="flex-1 w-full space-y-4">
                  ...
                  <div className="w-full">
                    <div className="flex justify-between text-[10px] font-sans uppercase tracking-widest text-gray-500 mb-1 font-bold">
